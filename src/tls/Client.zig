// Original Sourcode: https://github.com/ziglang/zig/blob/master/lib/std/crypto/tls/Client.zig
...
pub fn init(stream: anytype, ca_bundle: Certificate.Bundle, host: []const u8,comptime alpn :anytype) InitError(@TypeOf(stream))!Client {
    ...
    tls.extension(.application_layer_protocol_negotiation, // modified
         int2(@intCast(alpn.len)) ++ alpn) ++ 
